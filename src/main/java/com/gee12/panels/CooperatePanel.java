...
import com.gee12.other.DeleteRowListener;
 ...
 * @author Иван
 */
public class CooperatePanel extends JPanel implements DeleteRowListener {
...
//            Stages.STAGE2_COOPERATION);
    ...
    private void saveCooperateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveCooperateButtonActionPerformed
        XLSParser.saveXLSProjectData(projectFileName, Stages.STAGE2_COOPERATION, dataCooperateTM.getData());
    ...
    private void saveRatingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveRatingButtonActionPerformed
        XLSParser.saveXLSProjectData(projectFileName, Stages.STAGE3_RATING, dataRatingTM.getData());
